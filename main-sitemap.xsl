			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - MOJE</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Mapa del sitio XML - MOJE</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://elian-osorio.github.io/blooms-website/sitemap_index.xml">&#8592; Índice del mapa del sitio</a>							</p>
